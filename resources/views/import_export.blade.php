	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Imported <b>Data</b></h2>
					</div>
					<div class="col-sm-6">
                    <form id="import_file"  >
                        
                        <input type="file" name="excel_file" accept=".xlsx">
						<button type="submit" class="btn btn-danger logout"><span>Import File</span></button>						
                    </form>
					</div>
				</div>
			</div>
        ...
        <a href="{{route('download')}}" class="btn btn-success">Download ZIP</a> 
	</div>       
